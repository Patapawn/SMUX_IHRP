...
//define("DB_NAME", "smuxtrem_logintest");
//define("DB_USER", "smuxtrem_admin");
//define("DB_PASS", "N>NH~n.k5>f@");

define("DB_NAME", "smuxhrdb");
define("DB_USER", "root");
define("DB_PASS", "root");
 ...
 */
define("EMAIL_USE_SMTP", true);
define("EMAIL_SMTP_HOST", "ssl://polar.vodien.com");
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "smuxtrem");
define("EMAIL_SMTP_PASSWORD", "k5FfvDoJgQ");
define("EMAIL_SMTP_PORT", 465);
define("EMAIL_SMTP_ENCRYPTION", "ssl");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://127.0.0.1/smuxHRportal/PHPLOGIN/password_reset.php");
 ...
 */
define("EMAIL_VERIFICATION_URL", "http://127.0.0.1/smuxHRportal/MemberPages/MemberVerify.php");
define("EMAIL_VERIFICATION_FROM", "no-reply@smuxtremists.net");
define("EMAIL_VERIFICATION_FROM_NAME", "SMUXtremists");
define("EMAIL_VERIFICATION_SUBJECT", "Activate for Fun Family & Adventure");
